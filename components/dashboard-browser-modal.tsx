...
interface DashboardBrowserModalProps {
  url: string
  onClose: () => void
  fileName: string
}

export function DashboardBrowserModal({ url, onClose, fileName }: DashboardBrowserModalProps) {
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 bg-white border-b border-gray-200 shadow-sm min-h-[60px]">
        <div className="flex-1 min-w-0 pr-4">
          <p className="text-sm font-medium text-gray-900 truncate">Dashboard: {fileName}</p>
